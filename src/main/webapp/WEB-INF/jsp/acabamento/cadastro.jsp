	...
	<div class="container">
	  ...
	  <form action="/acabamento/incluir" method="post">
	    ...
	    <div class="form-group">
	      ...
	      <input type="text" value="Acabamento da cozinha" class="form-control" placeholder="Entre com a descrição" name="descricao">
	    </div>
	    ...
	    <div class="form-group">
	      <label>Piso:</label>
	      <input type="text" value="Cerâmica" class="form-control" placeholder="Entre com o piso" name="piso">
	    </div>
	    ...
	    <div class="form-group">
			<label class="checkbox-inline"><input type="checkbox" name="rodape" checked>Rodapé</label>
	    </div>
